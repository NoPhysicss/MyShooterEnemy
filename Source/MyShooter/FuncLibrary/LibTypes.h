...
public:
	...
	static void AddEffectBySurfaceType(AActor* TakeEffectActor, FName NameBoneHit, TSubclassOf<UMyShooter_StateEffect> AddEffectClass, EPhysicalSurface SurfaceType, FVector HitLocation);
};